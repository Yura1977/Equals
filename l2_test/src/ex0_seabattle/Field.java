 ...
 */
public class Field {
    static final int SIZE = 20;//Размер поля
    public static final int SHIPS_AMOUNT = 7; //Количество располагаемых кораблей
    char[] cells = new char[SIZE];
    ex0_seabattle.Ship[] ships = new ex0_seabattle.Ship[SHIPS_AMOUNT];
